            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="/cart">Carrinho - <span class="cart-amunt">R$100</span> <i class="fa fa-shopping-cart"></i> <span class="product-count"><?php echo htmlspecialchars( $nrProducts, ENT_COMPAT, 'UTF-8', FALSE ); ?></span></a>
                    </div>
                </div>
            </div>
        </div>
