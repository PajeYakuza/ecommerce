            ...
            <div class="col-md-12">
                <div class="product-pagination text-center">
                    <nav>
                        ...
                        <li>
                            <a href="<?php echo htmlspecialchars( $prevPage, ENT_COMPAT, 'UTF-8', FALSE ); ?>" aria-label="Previous">
                        ...
                        <?php if( $curPage<$total ){ ?>

                        <li>
                            <a href="<?php echo htmlspecialchars( $nextPage, ENT_COMPAT, 'UTF-8', FALSE ); ?>" aria-label="Next">
                            <span aria-hidden="true">»</span>
                            </a>
                        </li>
                        <?php } ?>
